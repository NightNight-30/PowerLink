...
# -*- coding: utf-8 -*-
"""
【Step2】邓白氏P51060接口 - 数据解析(Databricks版)
...
执行方式：
  spark-submit P51060-step2_data_parse.py [公司名]
"""
...
def main():
    ...
    print("=" * 60)
    print(f"【Step2】邓白氏{INTERFACE_KEY}接口({INTERFACE_NAME}) - 数据解析(Databricks版)")
    print("=" * 60)
    ...
    try:
        ...
        for i, rec in enumerate(records, 1):
            ...
            try:
                row = parse_paydex_data(rec['output_result'], keyword, rec['id'])
                if row is None:
                    stats['SKIP_EMPTY'] += 1
                    continue
